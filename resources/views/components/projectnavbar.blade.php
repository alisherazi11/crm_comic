        ...
        <ul class="navbar-nav mr-auto align-items-center">
            <li class="nav-item dropdown user-header">
                ...
                <div
                    ...
                    <a style="color:black; margin-left:20px; {{(request()->is('project')) ? 'background-color: #2980B9; color:white; padding: 10px; border-radius:10px;' : ''}}"
                        href="/project"
                    >Project</a
                    >
                    <a style="color:black; margin-left:20px; {{(request()->is('user')) ? 'background-color: #2980B9; color:white; padding: 10px; border-radius:10px;' : ''}}"
                        href="/user"
                    >User</a
                    >
                    <a style="color:black; margin-left:20px; {{(request()->is('newdashboard')) ? 'background-color: #2980B9; color:white; padding: 10px; border-radius:10px;' : ''}}"
                        href="{{url('newdashboard')}}"
                    >Dashboard</a>
                    <a style="color:black; margin-left:20px; {{(request()->is('newdashboard')) ? 'background-color: #2980B9; color:white; padding: 10px; border-radius:10px;' : ''}}" href="/admin/contacts"
                        ><img src="${url}/contact.png" alt=""><span class="menu-title"
                            ><span class="menu-title"
                            >My Contacts</span
                        ></a>
                    ...
                    <div class="dropdown userdropdown">
                        ...
                        <div class="row">
                            <div class="col-sm-2 mt-2">
                                ...
                                <a style="color:black; {{(request()->is('dashboard')) ? 'background-color: #2980B9; color:white; padding-right: 20px; border-radius:10px;' : ''}}"
