                        ...
                        @foreach ($users as $item)
                            <tr>
                                <td>
                                    ...
                                    <div class="userName1">
                                        <input type="checkbox" name="lists[]" class="lists" value="{{ $item->id }}" />
                                        <div class="tableProfile">AS</div>
                                        <div>
                                            <p class="text-bold">List</p>
                                            <p>Developer</p>
                                        </div>
                                    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('/admin/add-list') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="">
                            ...
                            <div class="form-group">
                                <select name="type" class="form-control selectpsacing selLead w-100"
                                    ...
                                    <option selected value="User" selected>User</option>
                        ...
                        <div class="modalbtnContainer">
                            ...
                            <button class="addbtn" type="submit">Add List</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="modal fade" id="exampleModalCenter6" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('admin/update-list') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="modalbtnContainer">
                            <button class="cancel" data-dismiss="modal">Cancel</button>
                            <button class="addbtn" type="submit">Edit List</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="modal fade" id="exampleModalCenterdel" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('admin/delete-list') }}" method="post">
