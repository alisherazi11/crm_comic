                ...
                @if ($errors->any())
                    @foreach ($errors->all() as $error)
                        <div class="text-danger"
                            style="font-size:14px;background:white;margin-bottom:7px;font-weight:bold;">{{ $error }}
                        </div>
                    @endforeach
                @endif --}}
            </div>
                        ...
                        @foreach ($users as $item)
                            <tr>
                                <td>
                                    ...
                                    <div class="userName1">
                                        <input type="checkbox" name="users[]" class="users" value="{{ $item->id }}" />
                    ...
                    <form action="{{ url('/admin/add-user') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="">
                            ...
                            <div class="form-group">
                                <select name="role" class="form-control selectpsacing selLead w-100"
                ...
                <div class="modal-body">
                    <form action="{{ url('admin/update-user') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="">
                            ...
                            <div class="form-group">
                                <select name="role" class="form-control selectpsacing selLead w-100" id="edit_role">
                        ...
                        <div class="modalbtnContainer">
                            <button class="cancel" data-dismiss="modal">Cancel</button>
                            <button class="addbtn" type="submit">Edit User</button>
                        </div>
                    </form>
                </div>
            </div>
